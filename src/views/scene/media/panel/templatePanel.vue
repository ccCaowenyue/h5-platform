    ...
    <div class="materialPanel">
        <div class="materialPanel-detail">
            <div class="materialPanel-detail-type">
                <div v-for="(item, index) in materialType" :key="index" class="materialPanel-detail-type-item"
            ...
            <div class="materialPanel-detail-list" v-for="(item, index) in panelDetailType" :key="index">
                ...
                <div class="materialPanel-detail-list-bar">
                    ...
                    <div class="materialPanel-detail-list-bar-right">
                        <span>全部</span>
                ...
                <div class="materialPanel-detail-list-content">
                    <div v-for="(item, index) in 6"
                        :key="index" class="materialPanel-detail-list-content-item">
                        {{ item }}
                    </div>
                </div>
            </div>
